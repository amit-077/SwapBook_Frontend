import { Box, Button, Image, Tag, Text, Tooltip } from "@chakra-ui/react";
...
const ItemCard = ({
  ...
  // let bookName = "Operating Systems Third Year I.T. Branch SPPU";
  // let discountedPrice = 1200;
  // let bookPrice = 1725;
            ...
            {bookDPrice != bookPrice && (
              <Box>
                <Tag size={"sm"} variant="solid" bgColor="#E8FFF3">
                  ...
                  >
                    {Math.round(100 - (bookDPrice * 100) / bookPrice) + "% off"}
                  </Text>
                </Tag>
              </Box>
            )}
